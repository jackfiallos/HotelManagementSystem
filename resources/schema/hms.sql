...
CREATE TABLE IF NOT EXISTS `hms`.`cancellations` (
  ...
  INDEX `fk_cancellations_room_id` (`room_id` ASC),
  INDEX `fk_cancellations_customer_id` (`customer_id` ASC),
...
CREATE TABLE IF NOT EXISTS `hms`.`payments` (
  ...
  `method` ENUM('efectivo', 'tarjeta', 'online') NULL,
  `booking_id` INT NOT NULL,
  `user_id` INT NOT NULL,
  PRIMARY KEY (`id`),
